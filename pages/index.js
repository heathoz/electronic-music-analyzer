...
import { Music, Play, Heart, Youtube, Instagram, Sparkles, Mail, Share2,
Linkedin, Copy } from 'lucide-react';
...
musicalDNA: [
"🎼 KEY: F# minor at A=440Hz (the 'melancholic hope' frequency)",
"🥁 BPM: 128.00 (perfect for trance hypnosis)",
"🎹 CHORD PROGRESSION: F#m - D - A - E (vi-bVI-bVII-V in A major - the 'emotional journey' progression)",
"⏱️ STRUCTURE: 32-bar phrases (matches human attention/breathing cycles)",
"🎼️ TIME SIGNATURE: 4/4 with subtle swing on hi-hats (use Track Delay +3ms on hi-hat track for laid-back feel)",
"🔊 ROOT NOTE: F# at 92.5Hz (sub-bass fundamental)"
],

abletonMasterclass: [
"🎛️ MAIN PLUCK: Wavetable → Modern Talking → Saw wave",
"• Oscillator pitch: -3 cents (creates beating with bass)",
"• ENV 1: Attack 47ms, Decay 1.2s, Sustain 0%, Release 2.1s",
"• Filter: Lowpass Legacy, Cutoff 2.1kHz, Resonance 1.8, Drive +6dB",
"• LFO 1: Rate 1/16, Amount +12 semitones to cutoff (creates movement)",
"",
"🔊 SUB BASS: Wavetable → Basic Shapes → Sine",
"• Root note F# (92.5Hz)",
"• Compressor: Ratio 4:1, Attack 10ms, Release 100ms",
"• Sidechain: Ghost kick every beat, -6dB reduction",
"",
"🎵 ARRANGEMENT LAYERS:",
...
"",
"🎛️ Filter Automation Psychology: The slow filter sweep from 800Hz to 8kHz over 64 bars creates physical tension in your chest (low frequencies = relaxation, high frequencies = excitement). The release feels like emotional catharsis.",
"",
...
"",
"🎛️ STEP 3: Build Emotional Tension",
...
musicalDNA: [
"🎼 KEY: F# minor at A=440Hz (melancholic but danceable)",
"🥁 BPM: 121.00 (the 'French house sweet spot' - slower than techno, groovier than deep house)",
"🎹 CHORD PROGRESSION: F#m - A - E - B (i-bIII-bVII-IV - the 'endless loop' progression)",
"🎤 VOCAL: 4-syllable phrase 'A-round-the-World' (2.64 seconds = perfect loop length)",
"⏱️ PHRASE LENGTH: 8 bars exactly (matches human breathing cycle)",
"🔊 BASS FUNDAMENTAL: F# at 92.5Hz (same as Strobe - deadmau5 studied this!)",
"🎛️ FILTER SWEEP: 32-bar cycles (200Hz to 12kHz and back)"
],

abletonMasterclass: [
"🎤 THE VOCAL CHOP: Audio track → Record/import 'Around the World' phrase → Crop to exactly 2 bars",
"• Simpler: Classic mode, Snap to zero-crossings ON",
"• Audio Effects: EQ Eight (High-pass 150Hz, Low-pass 8kHz) → Auto Filter → Compressor",
"",
"🔊 BASS LINE: Wavetable: Basic Shapes → Sine wave",
"• Root note F# (92.5Hz)",
"• Filter: Lowpass 24dB, Cutoff 400Hz, Drive +9dB",
"• Compressor: Ratio 6:1, Attack 3ms, Release 50ms",
"• Sidechain: Chain to kick drum (-4dB reduction)",
"",
"🎛️ THE MAGIC FILTER: Auto Filter on vocal track",
"• Type: Lowpass Legacy",
"• Frequency: Automate 200Hz to 12kHz over 32 bars",
"• Resonance: 2.1 (the 'French house resonance')",
"• Drive: +6dB",
"• LFO: OFF (manual automation only)",
"",
"🥁 DRUM GROOVE: Drum Rack: Four-on-the-floor kick pattern (909 sample on every beat), Open hat on 2 and 4",
"• Groove: Swing 16% (Ableton's MPC Swing 16)",
"• Kick processing: EQ (boost 60Hz +3dB, cut 400Hz -2dB)",
"• Hat processing: High-pass 8kHz, reverb send 15%",
"",
...
"",
"🎛️ 32-Bar Filter Cycles: Match human attention renewal. Every 30-35 seconds, your brain needs 'something new' or it loses focus. The filter sweep provides just enough change to reset attention without breaking the trance.",
"",
...
"",
"🎛️ STEP 2: Build the French Filter",
...
musicalDNA: [
"🎼 KEY: Atonal/polytonal (multiple key centers simultaneously - F# minor vs C major)",
"🥁 BPM: 129 BPM base with constant micro-timing shifts (+/- 3-7ms)",
"🎹 HARMONY: Dissonant clusters (C-C#-D played together creates 'organized ugliness')",
"⏱️ TIME SIGNATURES: 4/4 base with 7/8, 5/4, and 11/8 fragments",
"🎤 VOCAL PROCESSING: Time-stretched 200-400%, then pitch-shifted in opposite directions",
"🔊 FREQUENCY SPECTRUM: Intentional gaps at 800Hz and 3.2kHz (makes space for glitches)",
"🎼️ RHYTHMIC PATTERNS: Polyrhythms layered: 1/16 + 1/7 + 1/11 note divisions create 'never-repeating' illusion"
],

abletonMasterclass: [
"🎤 GLITCH VOCALS: Audio track → Beat Repeat: Gate 1/16, Pitch 1/8, Mix 35%",
"• Frequency Shifter: Coarse +7 semitones, Fine -23 cents",
"• Corpus: Type: Beam, Frequency 440Hz, Decay 2.1s",
"• Chain after: Auto Filter (Notch, random LFO) → Redux (8-bit, 8kHz)",
"",
"🎛️ CONTROLLED RANDOMNESS: Max for Live LFO: Rate 1/7 notes (creates polyrhythm against 4/4)",
"• Route to: Filter frequency, Reverb size, Delay feedback",
"• Expression Control: Map to Push rotaries for live 'organized chaos' performance",
"",
"🔄 THE SIGNATURE STUTTER: Beat Repeat device: Interval 1/16, Chance 45%, Gate 1/32",
"• Key Setting: Mix 100% (full replacement), Pitch 1/8 (creates melodic stutters)",
"• Pro Tip: Automate 'Chance' parameter: 0% for clean sections, 85% for chaos sections",
"",
"👽 ALIEN SYNTHESIS: Wavetable: Position at 67% through any wavetable",
"• Unison: 7 voices, detune 23 cents",
"• LFO 1: Rate 1/11 notes to wavetable position",
"• LFO 2: Rate 1/7 notes to filter cutoff",
"• Result: Never-repeating sonic evolution",
"",
"⏰ MICRO-TIMING MAGIC: Groove Pool: Create custom groove: kick +3ms, snare -2ms, hats +1ms",
"• Note: Tiny timing shifts = huge humanization. Richard uses 1-7ms variations maximum"
],
...
musicalDNA: [
"🎼 KEY: D minor at A=432Hz (tuned down 32 cents for 'healing frequency' warmth)",
"🥁 BPM: 122.00 (downtempo sweet spot - fast enough to groove, slow enough to breathe)",
"🎹 CHORD PROGRESSION: Dm - Bb - F - C (i-bVI-bIII-bVII - the 'cinematic sadness' progression)",
"🎵 ORGANIC LAYERS: Live recorded strings, found-sound textures, field recordings",
"⏱️ ARRANGEMENT: 6-8 minute builds (double pop song length = deeper emotional investment)",
"🔊 FREQUENCY BALANCE: Warm mids (400-800Hz boosted), rolled-off highs (8kHz+), present but not overwhelming bass",
"🎼️ DYNAMICS: Breathing room - elements fade in/out like human breath patterns"
],

abletonMasterclass: [
"🎵 THE BREATHING PAD: Wavetable: Mallets & Bells → Vintage Electric",
"• Unison: 4 voices, detune +/-7 cents (creates natural 'beating' like analog synths)",
"• Filter: Lowpass 4-pole, cutoff 2.8kHz, resonance 0.8",
"• LFO 1: Triangle wave, rate 0.25Hz to filter cutoff (+/-200Hz)",
"• Envelope: Attack 2.1s, Decay 4s, Sustain 65%, Release 3.8s (mimics string swells)",
"",
"🔊 FOUND SOUND TEXTURES: Drum Rack: Load vinyl crackle sample",
"• Simpler: Vintage mode ON, pitch drift +5 cents",
"• Volume: -35dB (barely audible but adds 'analog soul')",
"• Audio Effects: Saturator (Analog Clip mode, Drive +12dB) → EQ Eight (High-pass 80Hz, gentle high-shelf -2dB at 8kHz)",
"",
"🥁 ORGANIC DRUMS: Drum Rack: Layer acoustic + electronic samples",
"• Kick: 808 sub + live kick recording",
"• Snare: Electronic snare + tambourine layer",
"• Processing: Compressor (2:1 ratio, 30ms attack - slow enough to preserve transients)",
"• Reverb: Hybrid Reverb Hall mode, 2.1s decay, 15% wet",
"",
"🎻 STRING SECTION SIMULATION: Operator: Algorithm 4 (FM synthesis)",
"• Operator A: Sine wave, ratio 1.00",
"• Operator B: Sine wave, ratio 2.00, level 25%",
"• Global: Chorus device (Rate 0.8Hz, Amount 25%) → Reverb → EQ Eight (boost 1.2kHz +2dB for presence)"
],
...
"",
"❤️ The 'Uncanny Valley' of Emotion: Electronic music often falls into emotional uncanny valley - almost human but not quite. Bonobo bridges this by using organic textures, human timing variations, and breathing-pace builds. Result: Electronic music that feels genuinely emotional."
],
...
musicalDNA: [
"🎼 KEY: A minor at A=440Hz (dark but accessible)",
"🥁 BPM: 124.00 (the tech house sweet spot - fast enough for clubs, slow enough for radio)",
"🎹 CHORD PROGRESSION: Am - F - C - G (vi-IV-I-V - the 'pop progression' disguised as underground)",
"🎤 VOCAL CHOPS: 2-4 word phrases, heavily processed with formant shifting",
"⏱️ GROOVE: 16th note hi-hat rolls with 12% swing (the 'rolling' feel)",
"🔊 BASS PATTERN: Rolling 16th notes with subtle pitch bends (+/-25 cents)",
"🎛️ ARRANGEMENT: 32-bar loops with filter automation creating fake breakdowns",
"📻 RADIO SECRET: Vocal hook every 16 bars (pop structure hidden in techno framework)"
],

abletonMasterclass: [
"🔊 THE ROLLING BASS: Wavetable: Basic Shapes → Saw wave",
"• Unison: 3 voices, detune +/-12 cents",
"• Filter: Lowpass 4-pole, cutoff 800Hz, resonance 1.4, drive +9dB (the 'analog warmth')",
"• Pitch Bend: Automate pitch +/-25 cents on off-beats",
"• Compression: Compressor (6:1 ratio, 2ms attack, auto-release)",
"• Sidechain: Chain to kick (-3dB, fast attack)",
"",
...
"",
"🥁 THE ROLLING GROOVE: Drum Rack",
"• Kick: 909 sample, tune -2 semitones",
"• Hi-hats: Layer closed + open, swing 12%",
"• Percussion: Shaker every 16th, tambourine on off-beats",
"• Processing: Bus compression (2:1 ratio, slow attack) + parallel saturation",
"",
"🎛️ FILTER AUTOMATION MAGIC: Auto Filter on bass: Type: Lowpass",
"• Frequency: Automate 400Hz to 2kHz over 16 bars, then back",
"• Resonance: 1.8 (creates that 'whoomp' sound)",
"• Key: Map to Push knob for live performance",
"",
"🎵 ARRANGEMENT STRUCTURE:",
"• Bars 1-32: Kick + bass + minimal hats",
"• Bars 33-64: Add vocal chops",
"• Bars 65-96: Full arrangement",
"• Bars 97-128: Filter breakdown",
...
"",
"🎛️ Filter Automation as Emotional Manipulation: The 16-bar filter sweep from 400Hz to 2kHz literally guides your energy levels. Low frequencies = relaxed/grounded, higher frequencies = excited/elevated. DJs use this to control dancefloor energy without changing tracks.",
"",
...
musicalDNA: [
"🎼 KEY: Minimal/atonal (no harmonic content - pure rhythm and texture)",
"🥁 BPM: 130.00 (driving techno tempo - fast enough for intensity, controlled enough for precision)",
"🎹 HARMONIC CONTENT: None (revolutionary - proves melody isn't necessary for emotional impact)",
"🥁 CORE ELEMENTS: Kick (beats 1,3) + snare (beats 2,4) + micro hi-hat variations",
"⏱️ TIMING VARIATIONS: Microscopic shifts (+/-1-3ms) create human feel",
"🔊 FREQUENCY FOCUS: Sub-bass (40-60Hz), snare crack (2-4kHz), nothing else",
"🎛️ ARRANGEMENT: 64-bar cycles with subtle reverb automation",
"🧠 HYPNOTIC SECRET: Elements never fully repeat - always 99.7% same, 0.3% different"
],

abletonMasterclass: [
"🥁 THE PERFECT KICK: Drum Rack: Layer 3 samples:",
"• Sub: 909 kick tuned -7 semitones",
"• Punch: 909 kick pitched +2 semitones",
"• Click: High-frequency transient sample",
"• Chain: EQ Eight (boost 55Hz +3dB, cut 200Hz -2dB) → Compressor (8:1 ratio, 0.1ms attack, auto-release) → Saturator (Tube mode, +6dB drive)",
"",
"🥁 THE SNARE EVOLUTION: Drum Rack: 909 snare pitched down -7 semitones (creates that signature 'crack')",
"• Reverb: Hybrid Reverb Synth Hall, 1.8s decay",
"• Key Automation: Reverb send 0-40% over 64 bars (creates breathing space illusion)",
"• Compressor: Parallel compression (blend 30%) for punch retention",
"",
"⏰ MICROSCOPIC GROOVE: Groove Pool: Custom groove with tiny variations: kick +1ms, snare -0.5ms, hi-hat +2ms",
"• Swing: 2% maximum (minimal techno stays rigid)",
"• Timing: Random micro-shifts every 16 bars (+/-3ms maximum)",
"",
"🎵 THE ARRANGEMENT SECRET: Timeline:",
"• Nothing changes for first 2 minutes (builds tension through anticipation)",
"• Bars 33-64: Subtle reverb automation begins",
"• Bars 65-96: Hi-hat micro-variations introduced",
"• Bars 97-128: Snare reverb reaches maximum",
"• Pro Tip: Resist every urge to add elements - the emptiness IS the power",
"",
"🎛️ MIXING FOR POWER: Master chain:",
"• EQ Eight (high-pass 30Hz, boost 60Hz +1dB) → Compressor (2:1 ratio, slow attack) → Limiter (-0.1dB ceiling)",
"• Key: Leave frequencies 100-800Hz almost empty - creates space for the club's natural reverb"
],
...
musicalDNA: [
"🎼 KEY: F major at A=440Hz (the 'hope and joy' key - naturally uplifting)",
"🥁 BPM: 125.00 (deep house sweet spot - groove without rush)",
"🎹 CHORD PROGRESSION: F - Dm - Bb - C (I-vi-IV-V - the 'gospel progression' that triggers emotional familiarity)",
"🎤 VOCAL STYLE: Gospel runs, melismatic phrases, call-and-response structure",
"⏱️ PHRASING: 4-bar vocal phrases with 4-bar instrumental responses (church tradition)",
"🔊 BASS FREQUENCY: F at 87.3Hz (warm, round, supportive - never overpowering vocals)",
"🎛️ DYNAMICS: Natural vocal dynamics preserved (no over-compression)",
"✨ SPIRITUAL ELEMENT: Builds anticipation toward vocal climax = musical 'testimony' structure"
],

abletonMasterclass: [
"🎤 THE VOCAL THRONE: Audio track: ZERO pitch correction (preserve natural gospel inflections)",
"• EQ Eight: Gentle high-shelf +2dB at 8kHz, notch -2dB at 400Hz (space for bass)",
"• Compressor: 2:1 ratio, 30ms attack (preserves transients), auto-release",
"• Reverb: Hybrid Reverb Hall mode, 2.8s decay, 25% wet (church space simulation)",
"• Delay: 1/8 dotted note, 15% feedback, high-cut 6kHz",
"",
"🔊 SUPPORTIVE BASS: Wavetable: Basic Shapes → Sine wave",
"• Root note F (87.3Hz)",
"• Filter: Gentle lowpass 120Hz (removes upper harmonics)",
"• Compressor: 4:1 ratio, slow attack (lets transients through)",
"• Sidechain: Gentle 4-beat pump, -2dB maximum (subtle, supportive)",
"",
"🎹 GOSPEL CHORD PADS: Wavetable: Mallets & Bells → Vintage Electric",
"• Unison: 3 voices, detune +/-8 cents (analog warmth)",
"• ADSR: Attack 1.2s, Sustain 85%, Release 2.5s (organ-like swells)",
"• EQ: Roll-off below 200Hz (leave space for bass), gentle boost 1.5kHz (presence)",
"",
"🥁 DEEP HOUSE GROOVE: Drum Rack:",
"• Kick: Deep 808 style, tuned to F",
"• Hats: Closed on off-beats, open on beat 4",
"• Shaker: Constant 16th notes, low in mix",
"• Processing: Bus compression 2:1, slow attack",
"• Swing: 8% (subtle groove, not distracting from vocal)",
"",
"🎵 ARRANGEMENT RESPECT:",
"• Bars 1-16: Minimal backing, vocal spotlight",
"• Bars 17-32: Add subtle percussion",
"• Bars 33-48: Full arrangement enters",
"• Key: Always serve the vocal - it's the star, everything else supports"
],
...
const renderSection = (title, content, emoji, borderColor, trackTheme = 'default') => {
if (!content) return null;

// Color themes for different tracks/genres
const themeColors = {
'strobe': {
...
'aphex': {
bg: 'bg-gradient-to-br from-green-900/20 to-teal-900/20',
border: 'border-green-400/60', 
title: 'text-green-300',
text: 'text-green-50'
},
'bonobo': {
bg: 'bg-gradient-to-br from-rose-900/20 to-pink-900/20',
...
bg: 'bg-slate-800/40',
border: borderColor,
title: `text-${borderColor.includes('cyan') ? 'cyan' : borderColor.includes('orange') ? 'orange' : borderColor.includes('purple') ? 'purple' : 'emerald'}-400`,
text: 'text-gray-100'
}
};

const theme = themeColors[trackTheme] || themeColors['default'];

return (
<div className={`${theme.bg} backdrop-blur-lg rounded-2xl p-6 border ${theme.border} transition-all duration-300 hover:border-opacity-80`}>
<h3 className={`text-2xl md:text-3xl font-black mb-4 ${theme.title}`}>
{emoji} {title}
</h3>
{Array.isArray(content) ? (
<ul className={`${theme.text} leading-relaxed font-medium text-base md:text-lg space-y-2`}>
{content.map((item, index) => (
<li key={index} className={item === "" ? "h-3" : ""}>
{item && (item.startsWith('•') || item.includes(':') ? item : `• ${item}`)}
</li>
))}
</ul>
) : (
<p className={`${theme.text} leading-relaxed font-medium text-base md:text-lg whitespace-pre-line`}>
{content}
</p>
)}
</div>
...
<h1 className="text-5xl sm:text-6xl md:text-6xl font-black text-white drop-shadow-2xl mb-6 md:mb-8 px-2 tracking-tight">
Producer Hacks
</h1>
<p className="text-xl sm:text-2xl md:text-2xl text-gray-300 max-w-4xl mx-auto mb-6 md:mb-8 px-4 leading-tight font-bold">
Master electronic music production with insider hacks from deadmau5, Daft Punk, Aphex Twin & more.
</p>
<p className="text-base sm:text-lg md:text-lg text-gray-400 max-w-3xl mx-auto px-4 leading-relaxed font-medium">
Get step-by-step Ableton workflows and pro techniques you can use tonight.
</p>

<nav className="flex justify-center mb-8 md:mb-12 px-4 mt-8" role="navigation" aria-label="Main navigation">
...
className={`w-1/2 py-3 px-4 rounded-lg font-bold transition-all text-base ${
activeTab === 'analyzer'
...
{activeTab === 'about' && (
<article className="bg-slate-800/30 backdrop-blur-sm rounded-2xl p-8 md:p-10 border border-slate-700/50">
<div className="text-white space-y-6 md:space-y-8">
<h2 className="text-3xl md:text-4xl font-black text-cyan-400 mb-6 md:mb-8">Why I Built This Tool</h2>
...
<p className="text-base text-cyan-400 italic mt-8 md:mt-10 font-medium">- Heath Holme</p>
</div>
</article>
)}
...
{activeTab === 'analyzer' && (
<>
<section className="bg-slate-800/30 backdrop-blur-lg rounded-2xl p-6 md:p-8 mb-6 md:mb-8 border border-slate-700/50">
<div className="flex items-center justify-between mb-6 md:mb-8">
<div className="flex items-center">
<Sparkles className="w-7 h-7 md:w-8 md:h-8 mr-3 text-yellow-400" />
<h2 className="text-2xl md:text-3xl font-black text-white">Try These Sample Tracks</h2>
</div>
<span className="text-sm md:text-base text-gray-400 bg-slate-700/50 px-3 md:px-4 py-2 rounded-full font-medium">Demo Version</span>
</div>

<p className="text-lg md:text-xl text-gray-300 mb-6 text-center font-medium">
🎵 Click any track below to see the full analysis breakdown
</p>

<div ref={carouselRef} className="flex gap-4 md:gap-6 overflow-x-auto pb-4 md:pb-3 track-carousel">
<style jsx>{`
.track-carousel {
...
className="flex-shrink-0 bg-slate-700/50 hover:bg-slate-700/70 active:bg-slate-700/80 rounded-xl p-4 md:p-5 cursor-pointer transition-all hover:scale-105 active:scale-95 border border-slate-600/50 min-w-[280px] md:min-w-[300px] touch-manipulation"
role="button"
tabIndex={0}
onKeyDown={(e) => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); loadSampleTrack("https://youtu.be/dwDns8x3Jb4"); }}}
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-purple-500 to-pink-500 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">deadmau5</div>
<div className="text-white font-bold text-base md:text-lg truncate">Strobe</div>
<div className="text-gray-300 text-sm md:text-base font-medium">Progressive House • 10+ min epic</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-blue-500 to-purple-600 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">Daft Punk</div>
<div className="text-white font-bold text-base md:text-lg truncate">Around the World</div>
<div className="text-gray-300 text-sm md:text-base font-medium">House • Hypnotic loop</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-green-500 to-blue-500 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">Aphex Twin</div>
<div className="text-white font-bold text-base md:text-lg truncate">Windowlicker</div>
<div className="text-gray-300 text-sm md:text-base font-medium">IDM • Experimental chaos</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-pink-500 to-purple-500 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">Bonobo</div>
<div className="text-white font-bold text-base md:text-lg truncate">Heartbreak</div>
<div className="text-gray-300 text-sm md:text-base font-medium">Melodic House • Emotional journey</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-orange-500 to-red-500 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">CamelPhat & Elderbrook</div>
<div className="text-white font-bold text-base md:text-lg truncate">Cola</div>
<div className="text-gray-300 text-sm md:text-base font-medium">Tech House • Driving groove</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-gray-700 to-black rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">Plastikman</div>
<div className="text-white font-bold text-base md:text-lg truncate">Spastik</div>
<div className="text-gray-300 text-sm md:text-base font-medium">Techno • Minimal hypnosis</div>
</div>
</div>
</div>
...
>
<div className="flex items-center space-x-4">
<div className="w-14 h-14 md:w-16 md:h-16 bg-gradient-to-br from-yellow-600 to-amber-700 rounded-lg flex items-center justify-center">
<Music className="w-7 h-7 md:w-8 md:h-8 text-white" />
</div>
<div className="min-w-0 flex-1">
<div className="text-cyan-400 font-black text-lg md:text-xl truncate">Kings of Tomorrow</div>
<div className="text-white font-bold text-base md:text-lg truncate">Finally</div>
<div className="text-gray-300 text-sm md:text-base font-medium">Deep House • Gospel vibes</div>
</div>
</div>
</div>
</div>
...
<section className="bg-slate-800/30 backdrop-blur-lg rounded-2xl p-6 md:p-8 mb-8 md:mb-10 border border-slate-700/50">
<div className="flex items-center mb-6">
<Play className="w-7 h-7 md:w-8 md:h-8 mr-3 text-cyan-400" />
<h2 className="text-2xl md:text-3xl font-black text-white">Track Analysis</h2>
</div>
...
className="w-full px-4 py-4 md:py-4 bg-slate-700/50 border border-slate-600 rounded-xl text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/50 font-medium text-lg"
disabled={isLoading}
/>
<button
onClick={analyzeTrack}
disabled={isLoading || !youtubeUrl.trim()}
className="w-full md:w-auto md:self-start px-8 py-4 md:py-4 bg-cyan-500 hover:bg-cyan-600 disabled:bg-gray-600 text-white font-bold rounded-xl transition-all duration-200 disabled:cursor-not-allowed flex items-center justify-center min-h-[60px] shadow-lg hover:shadow-xl text-lg touch-manipulation"
>
{isLoading ? (
<>
...
{error && (
<div className="mt-6 p-4 bg-orange-500/20 border border-orange-400 rounded-xl text-orange-200 font-medium text-base">
{error}
</div>
)}
</section>
...
{/* Dynamic track-based theme detection */}
{(() => {
const getTrackTheme = () => {
if (analysis.title === "Strobe") return 'strobe';
if (analysis.title === "Around the World") return 'daftpunk';  
if (analysis.title === "Windowlicker") return 'aphex';
if (analysis.title === "Heartbreak") return 'bonobo';
if (analysis.title === "Cola") return 'cola';
if (analysis.title === "Spastik") return 'spastik';
if (analysis.title === "Finally") return 'finally';
return 'default';
};
const trackTheme = getTrackTheme();
const themeColors = {
'strobe': { accent: 'text-purple-400', bg: 'from-purple-900/30 to-pink-900/30', border: 'border-purple-400/60' },
'daftpunk': { accent: 'text-blue-400', bg: 'from-blue-900/30 to-indigo-900/30', border: 'border-blue-400/60' },
'aphex': { accent: 'text-green-400', bg: 'from-green-900/30 to-teal-900/30', border: 'border-green-400/60' },
'bonobo': { accent: 'text-rose-400', bg: 'from-rose-900/30 to-pink-900/30', border: 'border-rose-400/60' },
'cola': { accent: 'text-orange-400', bg: 'from-orange-900/30 to-red-900/30', border: 'border-orange-400/60' },
'spastik': { accent: 'text-gray-400', bg: 'from-gray-900/30 to-slate-900/30', border: 'border-gray-400/60' },
'finally': { accent: 'text-amber-400', bg: 'from-amber-900/30 to-yellow-900/30', border: 'border-amber-400/60' },
'default': { accent: 'text-cyan-400', bg: 'from-slate-800/30 to-slate-900/30', border: 'border-slate-700/50' }
};
const theme = themeColors[trackTheme];

return (
<>
<div className="bg-slate-800/20 backdrop-blur-sm rounded-2xl p-6 border border-slate-700/50">
<div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
<span className="text-white font-medium text-base md:text-lg">Love this analysis?</span>
...
className="flex items-center px-4 py-2 bg-red-600 hover:bg-red-700 active:bg-red-800 text-white rounded-lg transition-colors text-sm md:text-base whitespace-nowrap touch-manipulation font-medium shadow-lg"
onClick={() => {
if (window.gtag) {
...
className="flex items-center px-3 py-2 bg-orange-500 hover:bg-orange-600 active:bg-orange-700 text-white rounded-lg transition-colors text-sm md:text-base whitespace-nowrap touch-manipulation"
>
...
className="flex items-center px-3 py-2 bg-blue-700 hover:bg-blue-800 active:bg-blue-900 text-white rounded-lg transition-colors text-sm md:text-base whitespace-nowrap touch-manipulation"
>
...
className="flex items-center px-3 py-2 bg-gray-600 hover:bg-gray-700 active:bg-gray-800 text-white rounded-lg transition-colors text-sm md:text-base whitespace-nowrap touch-manipulation"
>
...
{analysis.title && (
<div className={`bg-gradient-to-r ${theme.bg} backdrop-blur-lg rounded-2xl p-8 md:p-10 border ${theme.border} text-center`}>
<h2 className={`text-4xl md:text-5xl font-black ${theme.accent} mb-4 leading-tight tracking-tight`}>{analysis.title}</h2>
{analysis.artist && <p className="text-2xl md:text-3xl text-white font-bold">{analysis.artist}</p>}
</div>
)}

<div className={`bg-gradient-to-r ${theme.bg} backdrop-blur-lg rounded-2xl p-8 md:p-10 border ${theme.border}`}>
<div className="flex items-center mb-6 md:mb-8">
<Heart className={`w-8 h-8 mr-4 ${theme.accent}`} />
<h3 className={`text-2xl md:text-3xl font-black ${theme.accent}`}>Musical Hook</h3>
</div>
<p className={`text-gray-100 leading-relaxed font-medium text-lg md:text-xl`}>{analysis.hook}</p>
</div>

{renderSection('Musical DNA', analysis.musicalDNA, '🧬', 'border-cyan-400/50', trackTheme)}
{renderSection('Ableton Masterclass', analysis.abletonMasterclass, '🎛️', 'border-orange-400', trackTheme)}
{renderSection('Producer Psychology', analysis.producerPsychology, '🧠', 'border-purple-400', trackTheme)}
{renderSection('Your Turn', analysis.yourTurn, '🚀', 'border-emerald-400', trackTheme)}
</>
);
})()}
</div>
...
<div className="bg-slate-900/90 backdrop-blur-lg rounded-2xl p-6 md:p-8">
<div className="text-center mb-6 md:mb-8">
<div className="w-12 h-12 md:w-14 md:h-14 mx-auto text-cyan-400 mb-4 text-3xl">🚀</div>
<h3 className="text-2xl md:text-3xl font-black text-white mb-3">Get Early Access!</h3>
<p className="text-gray-300 text-base md:text-lg">Be the first to know when new tracks are analyzed + get exclusive producer tips</p>
</div>
...
className="w-full px-4 py-4 bg-slate-700/50 border border-slate-600 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-cyan-400 focus:ring-2 focus:ring-cyan-400/50 text-base"
required
...
className="px-6 py-4 bg-cyan-500 hover:bg-cyan-600 active:bg-cyan-700 disabled:bg-gray-600 text-white font-bold rounded-lg transition-colors flex items-center justify-center touch-manipulation text-base"
>
{isSubmittingEmail ? (
<>
...
className="text-gray-400 hover:text-white py-2 px-2 touch-manipulation"
>
Maybe later
</button>
</div>
...
<div className="fixed bottom-4 right-4 bg-green-500 text-white px-6 py-4 rounded-lg shadow-lg z-50 max-w-sm">
✅ Thanks! Your email has been submitted successfully.
</div>
)}

<footer className="text-center mt-12 md:mt-16">
<div className="bg-slate-800/30 backdrop-blur-lg rounded-2xl p-6 md:p-8 max-w-md mx-auto border border-slate-700/50">
<p className="text-white text-base mb-4 md:mb-6 font-medium">Created by Heath Holme</p>
...
>
<Youtube className="w-5 h-5 md:w-6 md:h-6 mr-2" />
...
target="_blank"
rel="noopener noreferrer"
className="inline-flex items-center px-6 py-4 md:py-3 bg-yellow-500 hover:bg-yellow-600 active:bg-yellow-700 text-black font-bold rounded-lg transition-colors shadow-lg hover:shadow-xl touch-manipulation text-base md:text-lg"
>

...
musicalDNA: "🎼 **KEY:** G# minor at A=440Hz (the 'melancholic hope' frequency) • 🥁 **BPM:** 128.00 (perfect for trance hypnosis) • 🎹 **CHORD PROGRESSION:** F# / G#m / C#m / E (and variations including B and A as well) • ⏱️ **STRUCTURE:** 32-bar phrases (matches human attention/breathing cycles) • 🎼️ **TIME SIGNATURE:** 4/4 with subtle swing on hi-hats (+3ms) • 🔊 **ROOT NOTE:** G# at 103.83Hz (bass fundamental)",

abletonMasterclass: "🎛️ **ABLETON RECREATION GUIDE:**\n\n**MAIN PLUCK:** Wavetable → Basics → Basic Shapes → Saw wave • Oscillator pitch: -3 cents (creates beating with bass) • **ENV 1:** Attack 47ms, Decay 1.2s, Sustain 0%, Release 2.1s • **Filter:** Lowpass Legacy, Cutoff 2.1kHz, Resonance 1.8, Drive +6dB • **LFO 1:** Rate 1/16 note, Destination: Filter Cutoff, Amount: +25% (creates rhythmic movement)\n\n**SUB BASS:** Wavetable → Basic Shapes → Sine • Root note G# (103.83Hz) • **Compressor or Glue Compressor:** Ratio 4:1, Attack 10ms, Release 100ms • **Sidechain:** Ghost kick every beat, -6dB reduction\n\n**ARRANGEMENT LAYERS:**\n• **0:00-2:00:** Sub bass + minimal percussion\n• **2:00-4:30:** Add main pluck (filtered)\n• **4:30-7:00:** Layer strings pad (Wavetable → Keys → Electric Piano → E-Piano Classic)\n• **7:00-9:30:** Full arrangement + lead melody\n• **9:30-10:32:** Breakdown and outro\n\n**PRO TIP:** Automate Utility Gain instead of track volume - preserves dynamics",
...
musicalDNA: "🎼 **KEY:** C minor at A=440Hz (dark, introspective, perfect for experimental electronics) • 🥁 **BPM:** 123 BPM base with constant micro-timing shifts (+/- 3-7ms) • 🎹 **HARMONY:** C minor framework with chords: Cm - A♭ - Fm - F (i-♭VI-iv-IV progression creates harmonic tension) • ⏱️ **TIME SIGNATURES:** 4/4 base with 7/8, 5/4, and 11/8 fragments • 🎤 **VOCAL PROCESSING:** Time-stretched 200-400%, then pitch-shifted in opposite directions • 🔊 **FREQUENCY SPECTRUM:** Intentional gaps at 800Hz and 3.2kHz (makes space for glitches) • 🎛️ **RHYTHMIC PATTERNS:** Polyrhythms layered: 1/16 + 1/7 + 1/11 note divisions create 'never-repeating' illusion",

abletonMasterclass: "🎛️ **ABLETON CHAOS CREATION GUIDE:**\n\n**GLITCH VOCALS:** Audio track → **Beat Repeat:** Grid 1/16, Pitch +7 semitones, Chance 35%, Mix 35% • **Frequency Shifter:** Coarse +7 semitones, Fine -23 cents • **Corpus:** Type: Beam, Frequency 440Hz, Decay 2.1s • **Chain after:** Auto Filter (Notch, random LFO) → Redux (8-bit, 8kHz)\n\n**CONTROLLED RANDOMNESS:** **Max for Live LFO:** Rate 1/7 notes (creates polyrhythm against 4/4) • Route to: Filter frequency, Reverb size, Delay feedback • **Expression Control:** Map to Push rotaries for live 'organized chaos' performance\n\n**THE SIGNATURE STUTTER:** **Beat Repeat device:** Grid 1/16, Chance 45%, Gate 1/16, Pitch +7 semitones (creates melodic stutters) • **Key Setting:** Mix 100% (full replacement) • **Pro Tip:** Automate 'Chance' parameter: 0% for clean sections, 85% for chaos sections\n\n**ALIEN SYNTHESIS:** **Wavetable:** Position at 67% through any wavetable • **Unison:** 7 voices, detune 23 cents • **Max for Live LFO:** Rate 1/11 notes to wavetable position • **Max for Live LFO:** Rate 1/7 notes to filter cutoff • **Alternative:** Use LFO rates of 0.19Hz and 0.29Hz respectively (at 123 BPM) • **Result:** Never-repeating sonic evolution\n\n**MICRO-TIMING MAGIC:** **Groove Pool:** Create custom groove: kick +3ms, snare -2ms, hats +1ms • **Note:** Tiny timing shifts = huge humanization. Richard uses 1-7ms variations maximum",
...
musicalDNA: "🎼 **KEY:** E♭ major at A=440Hz (subtle tonal center provides unconscious harmonic stability) • 🥁 **BPM:** 126.00 (driving techno tempo - fast enough for intensity, controlled enough for precision) • 🎹 **HARMONIC CONTENT:** Subtle tonal center in E♭ major (felt, not heard - provides musical satisfaction) • 🔊 **CORE ELEMENTS:** Kick (beats 1,3) + snare (beats 2,4) + micro hi-hat variations • ⏱️ **TIMING VARIATIONS:** Microscopic shifts (+/-1-3ms) create human feel • 🔊 **FREQUENCY FOCUS:** Sub-bass (40-60Hz), snare crack (2-4kHz), E♭ fundamental • 🎛️ **ARRANGEMENT:** 64-bar cycles with subtle reverb automation • 🧠 **HYPNOTIC SECRET:** Elements never fully repeat - always 99.7% same, 0.3% different",
